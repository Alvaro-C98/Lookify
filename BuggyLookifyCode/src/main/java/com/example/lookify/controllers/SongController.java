...
public class SongController {
	...
	//Buscar una cancion por nombre de artista
	@GetMapping("/search")
	public String search(Model model,@RequestParam(value="q") String name) {
		// TODO - finish later
		List<Song> artist = songService.artist(name);
		model.addAttribute("songs", artist);
		return "dashboard.jsp";
	}
	
	//Cargar una nueva cancion
	...
	//Mostrar una cancion en especifico
	@GetMapping("/songs/{id}")
